...
For this study, we utilize two primary datasets. The first dataset is donation infomation to congresspeople from both individuals and PACs throughout 2022, collected from Open Secrets. The second dataset is the 2022 union scorecards of both House and Senate members as calculated by the American Federation of Labor and Congress of Industrial Organizations (AFL-CIO).
