...
editor: source
abstract: "We explore the potential variations in congressional AFL-CIO scorescards among communities created by donor networks. The Null Hypothesis posits that these communities exhibit the same mean union score, while the Alternative Hypothesis suggests differences in mean union scores. To investigate these hypotheses, we conduct a comprehensive analysis of various donor network communities, employing statistical methods to assess and compare their union scores. We find that communities created by donor networks meaningfully represent different mean AFL-CIO scores."
---
